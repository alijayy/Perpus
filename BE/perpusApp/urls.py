...
from .views import UserViewSet, RegisterView, LoginView, BukuViewSet, BukuListView, PengembalianViewSet, PeminjamanViewSet, DendaViewSet, ReservasiViewSet
...
urlpatterns = [
    ...
    path('api/buku/', BukuListView.as_view(), name='login'),
